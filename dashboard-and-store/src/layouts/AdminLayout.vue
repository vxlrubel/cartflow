...
const mouseLeaveFromDropdown = () => {
  setTimeout(() => {
    toggleAdminOptions.value = false
  }, 1500)
}
</script>
          ...
          <div class="flex justify-between h-11">
            ...
            <div class="flex items-center gap-2 relative h-full">
              ...
              >
                ...
                <a
                  href="#"
                  class="flex items-center gap-1 mb-2 text-gray-600 hover:text-gray-900 capitalize"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    height="16px"
                ...
                <router-link
                  ...
                  class="flex items-center gap-1 mb-2 text-gray-600 hover:text-gray-900"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    height="16px"
                ...
                >
                  ...
                  >
                    <path
                      d="M202.87-111.87q-37.78 0-64.39-26.61t-26.61-64.39v-554.26q0-37.78 26.61-64.39t64.39-26.61h279.04v91H202.87v554.26h279.04v91H202.87Zm434.02-156.65L574-333.93 674.56-434.5H358.09v-91h316.47L574-626.07l62.89-65.41L848.13-480 636.89-268.52Z"
                    />
                  </svg>
                  Logout
                </button>
