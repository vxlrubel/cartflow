...
<template>
  <div class="space-y-4">
    <div class="bg-white rounded-lg shadow">
      ...
      >
        <h2 class="text-2xl font-medium text-gray-800">Pending Orders</h2>
      </div>
          ...
          <table class="min-w-full divide-y divide-gray-200">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
              ...
              <tr v-else-if="store.orders.length === 0">
                <td colspan="10" class="px-4 py-8 text-center text-gray-500">No pending orders found</td>
              </tr>
              <tr v-for="order in store.orders" :key="order.id" class="hover:bg-gray-50">
                ...
                <td class="px-4 py-4">
                  <div class="flex items-center gap-2">
                    ...
                    <button
                      @click="updateSingleStatus(order.id, 'cancelled')"
