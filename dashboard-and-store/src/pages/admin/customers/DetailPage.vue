    ...
    <div class="bg-white rounded-lg shadow">
      ...
      <div v-else class="p-6">
          ...
          <div class="col-span-12 lg:col-span-8 space-y-5">
            ...
            <div class="pt-4">
              <button
                @click="handleSave"
                :disabled="saving"
                class="px-4 py-2 text-sm font-medium text-white bg-theme-600 rounded-lg hover:bg-theme-700 disabled:opacity-50"
              >
            ...
            <table class="min-w-full divide-y divide-gray-200">
              ...
              <tbody class="bg-white divide-y divide-gray-200">
                <tr v-for="order in orders" :key="order.id" class="hover:bg-gray-50">
                  ...
                  <td class="px-4 py-3">
                    <button @click="viewOrder(order.id)" class="text-theme-600 hover:text-theme-900 text-sm font-medium">View</button>
                  </td>
                </tr>
              </tbody>
            </table>
        ...
        <div v-else-if="activeTab === 'activity'" class="py-4">
          <button @click="viewActivity" class="px-4 py-2 text-sm bg-theme-600 text-white rounded-lg hover:bg-theme-700">
