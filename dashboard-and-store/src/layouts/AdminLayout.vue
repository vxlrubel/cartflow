        ...
        <div class="px-4 sm:px-6 lg:px-8">
          <div class="flex justify-between h-11">
            ...
            <div class="flex items-center gap-2 relative h-full">
                ...
                <div @mouseleave="mouseLeaveFromDropdown" class="absolute top-full right-0 w-35 px-3 py-2 bg-gray-200 border border-gray-300 rounded text-xs text-gray-700" v-show="toggleAdminOptions">
