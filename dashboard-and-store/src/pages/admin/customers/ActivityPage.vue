...
const getLogColor = (log) => {
  ...
  if (log.description?.includes('created')) return 'text-blue-600 bg-blue-50'
        ...
        <div v-if="lastPage > 1" class="flex items-center justify-between mt-4">
          ...
          <div class="flex gap-1">
            <button
              ...
              :class="['px-3 py-1 rounded text-sm', currentPage === page ? 'bg-indigo-600 text-white' : 'bg-gray-100 text-gray-700 hover:bg-gray-200']"
            >
              {{ page }}
            </button>
          </div>
