...
<template>
  <div class="space-y-4">
    <div class="bg-white rounded-lg shadow">
      ...
      >
        <h2 class="text-2xl font-medium text-gray-800">Returns / Refunds</h2>
      </div>
          ...
          <table class="min-w-full divide-y divide-gray-200">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
              ...
              <tr v-else-if="store.orders.length === 0">
                <td colspan="10" class="px-4 py-8 text-center text-gray-500">No return orders found</td>
              </tr>
              <tr v-for="order in store.orders" :key="order.id" class="hover:bg-gray-50">
                ...
                <td class="px-4 py-4">
                  <span class="inline-flex capitalize px-2 py-1 rounded-full text-xs font-medium bg-purple-100 text-purple-800">
                    {{ order.status || 'return' }}
                  </span>
                </td>
                <td class="px-4 py-4">
                ...
                <td class="px-4 py-4">
                  <div class="flex items-center gap-2">
                    ...
                    <button
                      @click="updateSingleStatus(order.id, 'completed')"
                      class="text-green-600 hover:text-green-900 text-sm font-medium"
                    >
                      Process
                    </button>
                    <button
                      @click="updatePaymentStatus(order.id, 'refunded')"
                      class="text-theme-600 hover:text-theme-900 text-sm font-medium"
                    >
                      Refund
                    </button>
